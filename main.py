...
parser.add_argument('--lrD', type=float, default=0.000025, help='learning rate for Critic, default=0.00005')
parser.add_argument('--lrG', type=float, default=0.000025, help='learning rate for Generator, default=0.00005')
...
netG = mlp.Generator(opt.imageSize, nz, ngf, ngpu)
